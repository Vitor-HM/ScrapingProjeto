...
def raspasgem(p_content):
    ...
    div_animes = anime.find_all(
        'div',
        class_='js-anime-category-producer seasonal-anime js-seasonal-anime js-anime-type-all js-anime-type-1',
    )
    ...
    for id, anime in enumerate(div_animes, start=1):
        ...
        if data:
            ...
            print(
                'Anime: ', '', v_nome_anime, '', 'Nao possui uma data definida'
            )
        ...
        for informacao in informacoes:
            ...
            if informacao.find('span', text=themas):
                ...
                l_temas = [
                    tema.text for tema in temas_tags
                ]  # Extrai os temas em uma lista
                v_temas = ', '.join(
                    l_temas
